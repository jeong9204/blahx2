...
import { useAuth } from '@/contexts/auth_user.content';
...
export const getServerSideProps: GetServerSideProps<Props> = async ({ query }) => {
  ...
  try {
    ...
    const beseUrl = `${protocol}://${host}:${port}`;
    const userInfoResp: AxiosResponse<InAuthUser> = await axios(`${beseUrl}/api/user.info/${screenName}`);
    return {
      props: {
